...
//     <>
//       <Snackbar
//         // קובע את המיקום של הסנייק על המסך
//         anchorOrigin={{ vertical: "top", horizontal: "right" }}
//         // setOpenSnack שמתעדכן ע״י מטודת isSnackOpen הסנייק פתוח בהתאם למשתנה
//         open={isSnackOpen}
//         // fals-ל isSnackOpen שמעדכנת את setOpenSnack כאשר סוגרים את הסנייק מפעילים את מטודת
//         onClose={() => setOpenSnack(false)}
//         // קובע כמה זמן הסנייק יהיה פתוח
//         autoHideDuration={5000}
//       >
//         <Alert severity={snackColor} variant={snackVariant}>
//           {snackMessage}
...
//       <SnackbarContext.Provider value={setSnack}>
//         {
//           // value/setSnack וכך יקבל את children-אז בעצם הפכתי אותו ל(SnackbarProvider - בקומפוננטה שלי) App.tsx שאעטפתי את
//           children
//         }
//       </SnackbarContext.Provider>
//     </>
